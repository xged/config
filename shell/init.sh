    ...
    yay -S --noconfirm --needed google-chrome-dev emacs adobe-source-code-pro-fonts tree aspell-en xorg-xbacklight xsel xvkbd xrandr gnirehtet timew scrcpy imagewriter piper-git
