...
before packages are loaded."
  ...
  (KB-i "<key-chord> kf" (lambda () (interactive) (insert "()") (backward-char))) (KB-i "<key-chord> fk" (lambda () (interactive) (insert "()") (backward-char)))
  (KB-n "<key-chord> kf" (lambda () (interactive) (insert "()"))) (KB-n "<key-chord> fk" (lambda () (interactive) (insert "()")))
  (KB-v "<key-chord> kf" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert ")") (goto-char beg) (insert "(")))) (KB-v "<key-chord> fk" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert ")") (goto-char beg) (insert "("))))
  (KB-i "<key-chord> kd" (lambda () (interactive) (insert "[]") (backward-char))) (KB-i "<key-chord> dk" (lambda () (interactive) (insert "[]") (backward-char)))
  (KB-n "<key-chord> kd" (lambda () (interactive) (insert "[]"))) (KB-n "<key-chord> dk" (lambda () (interactive) (insert "[]")))
  (KB-v "<key-chord> kd" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert "]") (goto-char beg) (insert "[")))) (KB-v "<key-chord> dk" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert "]") (goto-char beg) (insert "["))))
  (KB-i "<key-chord> ks" (lambda () (interactive) (insert "{}") (backward-char))) (KB-i "<key-chord> sk" (lambda () (interactive) (insert "{}") (backward-char)))
  (KB-n "<key-chord> ks" (lambda () (interactive) (insert "{}"))) (KB-n "<key-chord> sk" (lambda () (interactive) (insert "{}")))
  (KB-v "<key-chord> ks" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert "}") (goto-char beg) (insert "{")))) (KB-v "<key-chord> sk" (lambda (beg end) (interactive  "r") (save-excursion (goto-char end) (insert "}") (goto-char beg) (insert "{"))))
  ...
  (KB-nm "/" 'spacemacs/toggle-truncate-lines)
  (KB-M "/" 'spacemacs/toggle-truncate-lines)
