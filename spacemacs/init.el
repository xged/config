...
before packages are loaded."
  ...
  (xged/kb-nmv "a" 'evil-jump-backward)
  (xged/kb-nmv "A" 'evil-jump-forward)
  ...
  (xged/kb-nmv "e" 'subword-forward)
  (xged/kb-nmv "E" 'subword-backward)
  (xged/kb-nmv "w" 'evil-jump-item)
  (xged/kb-nmv "W" 'evil-jump-out-args)
  (xged/kb-nv "y" (kbd "i SPC <escape>"))
  ...
  (xged/kb-nmv "SPC h" 'back-to-indentation)
  (xged/kb-nm "SPC l" 'end-of-line)
  (xged/kb-v "SPC l" 'evil-last-non-blank)
  ...
  (xged/kb-nm "gj" 'xged/goto-j)
  (xged/kb-nm "gf" 'xged/goto-f)
  (xged/kb-nm "gk" 'xged/goto-k)
