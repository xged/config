...
before packages are loaded."
  ...
  (xged/kb-nm "a RET" 'git-gutter+-next-hunk) (xged/kb-nm "ak" 'git-gutter+-previous-hunk)
  (xged/kb-nm "a SPC" 'magit-status)
  (xged/kb-nm "al" 'magit-log-current)
  (xged/kb-nm "ah" 'git-gutter+-show-hunk-inline-at-point)
  (xged/kb-nm "as" 'git-gutter+-stage-hunks)
  (xged/kb-nm "aS" 'magit-stage-file)
  (xged/kb-nm "au" 'git-gutter+-unstage-whole-buffer)
  (xged/kb-nm "ad" 'git-gutter+-revert-hunk)
  (xged/kb-nm "ac" 'magit-commit-create)
  (xged/kb-nm "af" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-instant-fixup)))
  (xged/kb-nm "aF" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-fixup)))
  (xged/kb-nm "aq" 'magit-abort-dwim)
  (xged/kb-nm "a," 'magit-rebase-continue)
  (xged/kb-nm "ae" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-extend)))
  (xged/kb-nm "az" (lambda () (interactive) (magit-run-git "stash")))
  (xged/kb-nm "aZ" (lambda () (interactive) (magit-run-git "stash" "pop")))
  (xged/kb-nm "aS" (lambda () (interactive) (magit-snapshot-save t t nil t)))
  (xged/kb-nm "ap" (lambda () (interactive) (magit-push-current-to-pushremote "-f")))
  (xged/kb-nm "ab" 'spacemacs/git-blame-micro-state)  ;/ modifies the file
  (xged/kb-nm "at" 'spacemacs/time-machine-transient-state/body)
