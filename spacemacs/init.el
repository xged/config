...
before packages are loaded."
  ...
  (KB-nm "sY" (lambda () (interactive) (diff-hl-stage-current-hunk) (magit-commit-create (list "-m" "SEMI-STYLE"))))
  ...
  (KB-nm "sz" (lambda () (interactive) (diff-hl-stage-current-hunk) (magit-stash-index "stash")))
