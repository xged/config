...
before packages are loaded."
  ...
  (xged/kb-nmv "q" 'next-buffer)
  (xged/kb-nmv "Q" 'previous-buffer)
  ...
  (xged/kb-nmv "C-d" 'delete-window)
  (xged/kb-nmv "M-S-D" 'delete-other-windows)
  ...
  (xged/kb-nmv "gS" 'spacemacs/switch-to-scratch-buffer)
  (xged/kb-nmv "gz" (lambda () (interactive) (find-file "/home/xged/src/config/zsh/.zshrc")))
  (xged/kb-nmv "gm" 'spacemacs/switch-to-messages-buffer)
  (xged/kb-nmv "gc" 'calculator)
  (xged/kb-nmv "gf" 'describe-function)
  (xged/kb-nmv "gv" 'describe-variable)
  (xged/kb-nmv "gb" 'describe-bindings)
  (xged/kb-i "M-b" 'describe-bindings)
  (xged/kb-nmv "gL" 'ivy-spacemacs-help-layers)  ; layers
  (xged/kb-nmv "gp" 'ivy-spacemacs-help)  ; packages
  (xged/kb-nmv "gd" 'spacemacs/jump-to-definition)
