...
before packages are loaded."
  ...
  (xged/kb-nm "s S-<return>" (lambda () (interactive) (git-gutter+-stage-hunks) (concat "MAJOR "(magit-commit-create (list "-m" (number-to-string (1+ (string-to-number (shell-command-to-string "git rev-list --count HEAD")))))))))
  ...
  (xged/kb-nm "sY" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-create (list "-m" (concat "MAJOR STYLE "(number-to-string (1+ (string-to-number (shell-command-to-string "git rev-list --count HEAD")))))))))
  (xged/kb-nm "se" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-create (list "-m" (concat "REFACTOR "(number-to-string (1+ (string-to-number (shell-command-to-string "git rev-list --count HEAD")))))))))
  (xged/kb-nm "sE" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-create (list "-m" (concat "MAJOR REFACTOR "(number-to-string (1+ (string-to-number (shell-command-to-string "git rev-list --count HEAD")))))))))
