...
before packages are loaded."
  ...
  (xged/kb-nmv "s RET" 'git-gutter+-next-hunk) (xged/kb-nmv "sk" 'git-gutter+-previous-hunk)
  (xged/kb-nmv "s SPC" 'magit-status)
  (xged/kb-nmv "sl" 'magit-log-current)
  (xged/kb-nmv "sh" 'git-gutter+-show-hunk-inline-at-point)
  (xged/kb-nmv "ss" 'git-gutter+-stage-hunks)
  (xged/kb-nmv "sS" 'magit-stage-file)
  (xged/kb-nmv "su" 'git-gutter+-unstage-whole-buffer)
  (xged/kb-nmv "sd" 'git-gutter+-revert-hunk)
  (xged/kb-nmv "sc" 'magit-commit-create)
  (xged/kb-nmv "sf" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-instant-fixup)))
  (xged/kb-nmv "sF" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-fixup)))
  (xged/kb-nmv "sq" 'magit-abort-dwim)
  (xged/kb-nmv "s," 'magit-rebase-continue)
  (xged/kb-nmv "se" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-extend)))
  (xged/kb-nmv "sz" (lambda () (interactive) (magit-run-git "stash")))
  (xged/kb-nmv "sZ" (lambda () (interactive) (magit-run-git "stash" "pop")))
  (xged/kb-nmv "sS" (lambda () (interactive) (magit-snapshot-save t t nil t)))
  (xged/kb-nmv "sp" (lambda () (interactive) (magit-push-current-to-pushremote "-f")))
  (xged/kb-nmv "sb" 'spacemacs/git-blame-micro-state)  ;/ modifies the file
  (xged/kb-nmv "st" 'spacemacs/time-machine-transient-state/body)
