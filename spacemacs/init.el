...
before packages are loaded."
  ...
  (xged/kb-v "F" 'er/contract-region)
  ...
  (xged/kb-nmv "C-<return>" 'xged/forward-paragraph)
  ...
  (xged/kb-nm "n" 'xged/next)
  (xged/kb-nm "N" 'xged/previous)
  (xged/kb-v "n" 'evil-visualstar/begin-search-forward)
  (xged/kb-v "N" 'evil-visualstar/begin-search-backward)
  (xged/kb-nmv "m" 'evil-jump-backward)
  (xged/kb-nmv "M" 'evil-jump-forward)
  (xged/kb-nmv "SPC k" 'goto-last-change)
  (xged/kb-nmv "SPC s" (lambda () (interactive) (spacemacs/default-pop-shell) (centered-cursor-mode -1) (setq truncate-lines nil)))
  (xged/kb-nmv "SPC t" (lambda () (interactive) (find-file "/home/xged/src/private/notes.yaml")))
  (xged/kb-nmv "SPC e" 'spacemacs/find-dotfile)
  (xged/kb-nmv "SPC RET" (lambda () (interactive) (flycheck-next-error 1 t)))
  (xged/kb-nmv "SPC S-RET" (lambda () (interactive) (flycheck-next-error -1 t)))
  (xged/kb-nmv "SPC n" 'evil-ex-search-next)
  (xged/kb-nmv "SPC N" 'evil-ex-search-previous)

  ;; Key bindings: Manage (Project)
  (bind-key* (kbd "<key-chord> df") 'evil-escape)
  (bind-key* (kbd "<key-chord> fd") 'evil-escape)
  ...
  (xged/kb-nm "M-d" 'spacemacs/delete-current-buffer-file)
  (xged/kb-nm "C-d" 'delete-window)
  (xged/kb-nm "M-S-D" 'delete-other-windows)
  (xged/kb-nm "SPC w" 'xged/window-next)
  ...
  (xged/kb-nmv "gg" 'evil-goto-first-line)
  (xged/kb-nmv "g <end>" 'evil-goto-line)
  (xged/kb-nmv "gh" 'back-to-indentation)
  (xged/kb-nm "gl" 'end-of-line)
  (xged/kb-v "gl" 'evil-last-non-blank)
  (xged/kb-nmv "gx" 'evil-visual-restore)
  (xged/kb-nm "gS" 'spacemacs/switch-to-scratch-buffer)
  (xged/kb-nm "gz" (lambda () (interactive) (find-file "/home/xged/src/config/zsh/.zshrc")))
  (xged/kb-nm "gm" 'spacemacs/switch-to-messages-buffer)
  (xged/kb-nm "gc" 'calculator)
  (xged/kb-nm "gf" 'describe-function)
  (xged/kb-nm "gv" 'describe-variable)
  (xged/kb-nm "gb" 'describe-bindings)
  (xged/kb-i "M-b" 'describe-bindings)
  (xged/kb-nm "gL" 'ivy-spacemacs-help-layers)  ; layers
  (xged/kb-nm "gp" 'ivy-spacemacs-help)  ; packages
  (xged/kb-nm "gd" 'spacemacs/jump-to-definition)
  ...
  (xged/kb-nmv "u" 'evil-undo)
  (xged/kb-nmv "U" 'evil-redo)
  ...
  (xged/kb-nm "y" (lambda () (interactive) (insert " ")))
  (xged/kb-nm "<" 'evil-shift-left-line)
  (xged/kb-nm ">" 'evil-shift-right-line)
  ...
  (xged/kb-nm "v" 'xged/insert-line-below)
  (xged/kb-nm "V" 'xged/insert-line-above)
  (xged/kb-nmv "SPC D" 'comment-kill)
  (xged/kb-nmv "j" 'evil-join)

  ;; Key bindings: Magic
  (xged/kb-nm "SPC SPC" 'counsel-M-x)
  (xged/kb-nm "S-SPC" 'ivy-resume)
  ...
  (xged/kb-nm "/" 'spacemacs/toggle-truncate-lines)
  (xged/kb-M "/" 'spacemacs/toggle-truncate-lines)
  (xged/kb-nm "M-q" (lambda () (interactive) (configuration-layer/update-packages) (shell-command "git -C ~/.emacs.d pull --rebase") (spacemacs/restart-emacs-resume-layouts)))
  (xged/kb-nm "t" 'xged/time)
  ...
  (xged/kb-nm "ss" (lambda () (interactive) (git-gutter+-stage-hunks) (git-gutter+-next-hunk 1))) (advice-add 'git-gutter+-stage-hunks :before #'save-buffer)
  (xged/kb-v "SPC s" (lambda () (interactive) (git-gutter+-stage-hunks) (evil-normal-state)))
  (xged/kb-nm "sa" 'magit-stage)(advice-add 'magit-stage :before #'save-buffer)  ; file|all
  ...
  (xged/kb-nm "s <return>" (lambda () (interactive) (git-gutter+-stage-hunks) (magit-commit-create (list "-m" (number-to-string (1+ (string-to-number (shell-command-to-string "git rev-list --count HEAD"))))))))
  ...
  (xged/kb-nm "sQ" 'magit-rebase-continue)
