...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(highlight-parentheses rainbow-delimiters hl-line dired savehist)
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; If non-nil ELPA repositories are con variable has no effect if Emacs is launched with the parameter
...
before packages are loaded."
  ...
  (KB-nm "<escape>" 'spacemacs/alternate-buffer)
  (KB-nm "b" 'ivy-switch-buffer)
  (KB-nm "SPC d" 'kill-this-buffer)
  ...
  (KB-nm "SPC q" 'spacemacs/restart-emacs-resume-layouts)
  (KB-nm "C-q" 'spacemacs/kill-emacs)
  ...
  (KB-nm "sa" 'magit-stage-buffer-file)
  (KB-nm "su" 'magit-unstage-buffer-file)
  (KB-nm "sd" 'diff-hl-revert-hunk)
  (KB-nm "sc" (lambda () (interactive) (ignore-errors (diff-hl-stage-current-hunk)) (magit-commit-create)))
  (KB-nm "s <return>"
         (lambda ()
           (interactive)
  ...
  (KB-nm "sx" (lambda () (interactive) (ignore-errors (diff-hl-stage-current-hunk)) (magit-commit-create (list "-m" "FIX"))))
  (KB-nm "sy" (lambda () (interactive) (ignore-errors (diff-hl-stage-current-hunk)) (magit-commit-create (list "-m" "STYLE"))))
  (KB-nm "sY" (lambda () (interactive) (ignore-errors (diff-hl-stage-current-hunk)) (magit-commit-create (list "-m" "SEMI-STYLE"))))
  ...
  (set-face-attribute 'diff-hl-insert                 nil :background xged/color-string)
  (set-face-attribute 'diff-hl-delete                 nil :background nil :foreground xged/color-keyword)
  (set-face-attribute 'diff-hl-change                 nil :background xged/color-type)
